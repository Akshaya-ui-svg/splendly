...
### Structure
- `app.py`: Main entry point containing application routes and server configuration.
- `database/`: Contains database utility functions (e.g., `get_db`, `init_db`) for SQLite interactions.
- `static/`: Frontend static assets including CSS (`static/css/style.css`) and JavaScript (`static/js/main.js`).
- `templates/`: Jinja2 HTML templates for the application views.
